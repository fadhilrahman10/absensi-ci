  ...
  >
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <img
          ...
          alt="main_logo"
        />
        <span class="ms-1 font-weight-bold">Attandance</span>
      </a>
    </div>
    ...
    >
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../pages/pegawai.html">
            <div
              class="
                icon icon-shape icon-sm
                shadow
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/absen.html">
            <div
              class="
                icon icon-shape icon-sm
                shadow
            ...
            <span class="nav-link-text ms-1">Absent</span>
          </a>
        </li>
              ...
              <ul class="navbar-nav me-auto mb-lg-0">
                <li class="nav-item">
                  <a
                    class="nav-link"
                    aria-current="page"
                    href="/pages/rekap_pegawai.html"
                    >Data Pegawai</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/pages/rekap_absen.html"
                    >Data Attandance</a
                  >
                </li>
              </ul>
        ...
        <li class="nav-item">
          <a class="nav-link" href="../pages/akun.html">
            <div
              class="
                icon icon-shape icon-sm
                shadow
